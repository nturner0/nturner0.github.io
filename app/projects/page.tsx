...
import { projects, projects_personal } from '@/lib/constants';
			...
			<div className="container">
				...
				>
					...
					>
						...
						<h2 className="text-3xl font-bold mt-10">CERN</h2>
						<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
							Projects from my time working as an R&D Engineer at CERN.
						</p>
					</motion.div>
					...
					<motion.div
						...
						className="text-center mb-12"
					>
						<h2 className="text-3xl font-bold mt-10">Personal Projects</h2>
					</motion.div>
